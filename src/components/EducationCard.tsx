              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center w-8 shrink-0 relative">
                    ...
                    {/* Dot */}
                    <div className="relative z-10 mt-5 w-4 h-4 rounded-full bg-white dark:bg-neutral-900 border-2 border-gray-200 dark:border-neutral-600 group-hover:border-gray-500 transition-colors duration-300 flex items-center justify-center shadow-sm">
                      <div className="w-1.5 h-1.5 rounded-full bg-gray-300 dark:bg-neutral-500 group-hover:bg-gray-500 transition-colors duration-300"></div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-2 flex-wrap">
                            <span className="text-[10px] font-bold uppercase tracking-wider text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-900/30 px-2 py-0.5 rounded-full">
                              {edu.type}
                            </span>
                            <span className="text-[10px] font-bold uppercase tracking-wider text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-900/30 px-2 py-0.5 rounded-full border border-dashed border-gray-200 dark:border-neutral-600">
                              {edu.badge}
                            </span>
                        ...
                        <ChevronRight className="w-5 h-5 text-gray-300 dark:text-neutral-600 group-hover:text-gray-500 transition-transform group-hover:translate-x-1" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="h-full flex flex-col">
            <div className="mb-6">
              ...
              <div className="flex items-center gap-2 mb-2 flex-wrap">
                ...
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gray-50 dark:bg-gray-900/20 text-gray-700 dark:text-gray-300 text-xs font-mono border border-dashed border-gray-100 dark:border-gray-700/50">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {activeEdu?.courses.map((course, i) => (
                  <span
                    key={i}
                    className="px-3 py-1.5 rounded-lg text-xs font-medium bg-white dark:bg-neutral-800 border border-dashed border-gray-200 dark:border-neutral-600 text-gray-700 dark:text-gray-300 shadow-sm hover:border-gray-300 dark:hover:border-gray-600 transition-colors cursor-default"
                  >
                    {course}
                  </span>
                ))}
