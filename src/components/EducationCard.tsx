...
const EducationCard: React.FC = () => {
  ...
  return (
    <div className="h-full w-full bg-white dark:bg-neutral-900 p-6 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-100/40 dark:bg-emerald-900/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
