...
const FunFactsCard: React.FC = () => {
  const facts = [
    ...
    { text: "The way Itachi served I could serve you, just find me my purpose.", emoji: "🍥" },
    { text: "I am founder of abbreviation SLAP (Sound Like A Plan)", emoji: "🤝" },
    { text: "Big time Arsenal fan, once a Gooner always a Gooner", emoji: "⚽" }
  ];
  ...
  return (
    <div className="h-full w-full bg-white dark:bg-neutral-900 p-6 flex flex-col relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-4 relative z-10 shrink-0">
        ...
        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Fun Facts</h2>
      </div>
